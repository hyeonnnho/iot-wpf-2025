...
namespace BusanRestaurantApp.ViewModels
{
    public partial class BusanMatjibViewModel : ObservableObject
    {
        ...
        public async Task MatjibItemDoubleClick()
        {
            ...
            viewModel.SelectedMatjibItem = SelectedMatjibItem;  // 메인창에 있는 선택아이템을 그대로 구글맵으로 전달
        ...
        private async Task GetDataFromOpenApi()
        {
            ...
            string myServiceKey = "kO1Tgnr9TLxJvLP6nOk7%2FiGG08nKUk1WitMOzpjpV%2B%2B7ipktapacBpdqPiLPWiVeZj8XdrYE%2BYlvjv9S8Yv52g%3D%3D";
